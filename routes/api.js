        ...
        if (req.body.api_auth_token && req.body.api_auth_token === config.settings.api_auth_token) {
            ...
            common.validate_permalink(db, req.body, function(err, result) {
                ...
                if (validationResult === true) {
                    ...
                    db.users.findOne({
                        user_email: req.body.kb_author_email
                    }, function(err, user) {
                        ...
                        var featuredArticle = typeof req.body.kb_featured !== 'undefined'
                            ? req.body.kb_featured.toString()
                            : 'false';
                        var publishedArticle = typeof req.body.kb_published !== 'undefined'
                            ? req.body.kb_published.toString()
                            : 'false';
                        ...
                        db.kb.insert(doc, function(err, newDoc) {
                            ...
                            // add to store
                            var href = req.body.kb_permalink !== ''
